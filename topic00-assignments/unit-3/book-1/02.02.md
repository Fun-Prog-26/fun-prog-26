...
- We look at one function, multby2 which takes a list and multiplies all elements in the list by 2. 
...
Run this and see what happens. Would you expect this to work?