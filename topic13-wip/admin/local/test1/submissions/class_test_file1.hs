...
-- Answer i got for original question by checking prelude and experimenting 
-- j4:: (Float, Maybe Bool)
-- j4 = (4444.444, Just False)
...
j6:: (String, (Int, [Bool]))
j6 = ("newString", (20, [True, True, False]))

j7:: [[[Char]]]
j7 = [["starterString", "endingString"], ["technicallyAListOfChars", "alsoAListOfChars", "anotherOne"], ["oneLonelyList"]]

j8:: [(Double, [Int])]
j8 = [(3.2, [3,3,2]), (62.2, [6,8,2,2])]
