...
## `Module code`
This is a unique. The first character should be an uppercase letter, followed by digits and the length of the code must be between 6 and 9. 
...
- Ensure that there are 
   - at least 5 Learning Outcomes for Introductory and Intermediate modules, 
   - at least 7 Learning Outcomes for Advanced modules
   - at least  8 Learning Outcomes for PostGraduate modules.

### Optional 
- Check the suitability of the use of verbs depending on level. 

To check the use of suitable verbs you can see 
Mapping Module  Level  to Bloom’s Taxonomy
- Introductory = Knowledge ∪ Comprehension ∪ Application
- Intermediate = Application ∪ Analysis ∪ Synthesis
- Advanced = Analysis ∪ Synthesis ∪ Evaluation
- Postgraduate = Synthesis ∪ Evaluation