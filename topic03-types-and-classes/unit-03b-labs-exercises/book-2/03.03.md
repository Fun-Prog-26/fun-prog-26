# Precedence Worksheet
 ...
 - In this worksheet replace each  "X2 = undefined" with "X2 = fully-parenthesiszed-expression" such that X1 and X2 evaluate to the same value. 
